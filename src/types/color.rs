...
// Mathematical operator overloading for Color type on Color type
...
// Mathematical operator overloading for Color type on f32 type
...
// Logical operator overloading for type Color
